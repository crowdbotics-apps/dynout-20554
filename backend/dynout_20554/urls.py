"""dynout_20554 URL Configuration
...
admin.site.site_header = "Dynout"
admin.site.site_title = "Dynout Admin Portal"
admin.site.index_title = "Dynout Admin"

# swagger
api_info = openapi.Info(
    title="Dynout API",
    default_version="v1",
    description="API documentation for Dynout App",
)
